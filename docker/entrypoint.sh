#!/bin/sh
# Verdure MCP Server - Docker Entrypoint Script
# This script handles configuration file mounting and compression before starting the application

set -e

echo "=========================================="
echo "  Verdure MCP Server"
echo "=========================================="
echo ""
...
echo "Launching Verdure MCP Server..."
exec dotnet Verdure.Mcp.Server.dll "$@"
